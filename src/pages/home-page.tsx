...
export default function Home() {
    return (
        <div className="flex items-center justify-center min-h-screen min-w-screen bg-gray-100 text-gray-800 p-4">
            <div className="w-full bg-white rounded-lg shadow-md p-6 max-h-[100vh] max-w-[40vh]">
                ...
                <Button className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-lg transition ease-in-out duration-200 w-full">
                    Start here
                </Button>
            </div>
        </div>
