  ...
  return (
    <Card className="flex flex-col max-h-[350px]">
      <CardHeader className="items-center pb-0">
        <CardTitle>Number of Specialists</CardTitle>
      ...
      <CardContent className="flex-1 pb-0">
        ...
        >
          <RadialBarChart
            data={chartData}
            startAngle={0}
            endAngle={360} // Full circle for count display
            innerRadius={80}
            outerRadius={110}
          >
            <PolarGrid
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="leading-none text-muted-foreground text-center">
          Showing total number of specialists for the medical institutions in
          this region.
        </div>
      </CardFooter>
    </Card>
